...
<div class="from_div">
    <form  >
        <table align="center">
            <caption><h1 align="center" style="color: chartreuse">修改菜单信息</h1></caption>
            <tr>
                <td>编号</td>
                <td><input id="idb" value="${que.id}" disabled></td>
            </tr>
            <tr>
                <td>餐名</td>
                <td><input id="name" type="text" value="${que.name}" name="name"></td>
            </tr>
            <tr>
                <td>分类</td>
                <td>
                    <div class="m_button" onclick="button_ls()" onmouseleave="ul_bian()"><label id="mefood">${que.cut}</label>
                    ...
                    <input id="cname" type="text" value="${que.cut}" name="cname"></td>
            </tr>
            <tr >
...
<script>
    ...
    function button_add(){
        ...
        let name = $("#name").val();
        let cname = $("#cname").val();
        var data = {"id":id, "name": name, "cut": cname};
